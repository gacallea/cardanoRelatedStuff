...
```text
curl -sLOJ https://github.com/input-output-hk/jormungandr/releases/download/v0.8.14/jormungandr-v0.8.14-x86_64-unknown-linux-gnu.tar.gz
tar xzvf jormungandr-v0.8.14-x86_64-unknown-linux-gnu.tar.gz
